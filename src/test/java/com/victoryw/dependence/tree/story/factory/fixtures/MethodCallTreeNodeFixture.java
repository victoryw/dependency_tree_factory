...
public class MethodCallTreeNodeFixture {
    ...
    public static MethodVertex vertex13 = new MethodVertex(UUID.randomUUID().toString(), "className13.methodName13");
    public static MethodVertex vertex14 = new MethodVertex(UUID.randomUUID().toString(), "className14.methodName14");
    public static MethodVertex vertex15 = new MethodVertex(UUID.randomUUID().toString(), "className15.methodName15");
    ...
    static MethodCallDirectedEdge edge1_13 = new MethodCallDirectedEdge(vertex1, vertex13);
    static MethodCallDirectedEdge edge1_14 = new MethodCallDirectedEdge(vertex1, vertex14);
    static MethodCallDirectedEdge edge1_15 = new MethodCallDirectedEdge(vertex1, vertex15);
    ...
    public static MethodCallTreeNode sample() {
        MethodCallTreeNode root = new MethodCallTreeNode(vertex1);
        root.attachEdge(edge1_11);
        root.attachEdge(edge1_12);
        root.attachEdge(edge1_13);
        root.attachEdge(edge1_14);
        root.attachEdge(edge1_15);
